...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002359871576'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002453091105') # give your force subscribe channel id here else leave it blank
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+9s4LvsGNFO85YmNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+9s4LvsGNFO85YmNl')

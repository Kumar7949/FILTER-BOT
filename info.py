...
API_ID = int(environ.get('API_ID', '24969099'))
API_HASH = environ.get('API_HASH', '463f312f6f44a00f3e6977ee3b7f1dac')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/KQH.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1872508109').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002584988383'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002520556611').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002360684548') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002524031385').split()]  # For Multiple Id Use One Space Between Each.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@Teleguhdmovies_bot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Teleguhdmovies_bot')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'https://pocolinks.com')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '0efb284354ff597da0a048c103de88715860ada4')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Open_Shortner_Links/10')
